...
export default class DetailsAerienne extends Component {
  ...
  majState=()=>{
    const alim=AllBD()[0]["aerienne"][0]["alimentaires"];
    const chim=AllBD()[0]["aerienne"][0]["chimiques"];
    const mat= AllBD()[0]["aerienne"][0]["materiels"];
