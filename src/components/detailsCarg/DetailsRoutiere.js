...
export default class DetailsRoutiere extends Component {
  ...
  majState=()=>{
    const alim=AllBD()[0]["routiere"][0]["alimentaires"];
    const chim=AllBD()[0]["routiere"][0]["chimiques"];
    const mat= AllBD()[0]["routiere"][0]["materiels"];
