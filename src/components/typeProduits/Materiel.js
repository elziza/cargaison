...
export default function Materiel(props) {
  const {id,libelle,image,poids,volume,fraisAerienne,fraisMaritime,fraisRoutiere,type}= props.info;
  return (
    
    <div className='col-3'>

    <div className="card " >
        <a href={`#/produitMateriel/${id}`}>
      ...
      <div className="panel nonloop-block-13 owl-carousel d-flex">
        <ul>
                    ...
                    <li className="d-flex"><h6>Type : </h6><h6 className="price ml-auto">{type} </h6></li>
